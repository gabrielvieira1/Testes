...
public class Program {
	...
	public static void serializaListaTenis(Tenis[] tenis) {
		...
		try {
			ObjectOutputStream oS = new ObjectOutputStream(
					new FileOutputStream("F:\\Eclipse\\git\\Testes\\Testes\\src\\Serialização\\Tenis.txt"));
	...
	public static void desserializaListaTenis() throws IOException {
		Tenis[] arrayTenis = new Tenis[3];
		try {
			FileInputStream fileIn = new FileInputStream("F:\\Eclipse\\git\\Testes\\Testes\\src\\Serialização\\Tenis.txt");
